 ...
 function CreatePDF(user,test){
    ...
    var sintomas="";
     sintomas+=test.febre? "<li style=' list-style: none;margin-left: -45px;'>Febre</li>":"";
     sintomas+=test.tosse? "<li style=' list-style: none;margin-left: -45px;'>Tosse</li>":"";
     sintomas+=test.fadiga? "<li style=' list-style: none;margin-left: -45px;'>Fadiga</li>":"";
     sintomas+=test.respiracao? "<li style=' list-style: none;margin-left: -45px;'>Dificuldade de respirar</li>":"";
     sintomas+=test.garganta? "<li style=' list-style: none;margin-left: -45px;'>Dor de garganta</li>":"";
     sintomas+=test.calafrios? "<li style=' list-style: none;margin-left: -45px;'>Calafrios</li>":"";
     sintomas+=test.corpo? "<li style=' list-style: none;margin-left: -45px;'>Dor no Corpo</li>":"";
     sintomas+=test.cabeca? "<li style=' list-style: none;margin-left: -45px;'>Dor de cabeça</li>":"";
     sintomas+=test.coriza? "<li style=' list-style: none;margin-left: -45px;'>Nariz escorrendo (Coriza)</li>":"";
     sintomas+=test.espirros? "<li style=' list-style: none;margin-left: -45px;'> Espirros</li>":"";
