...
messaging.onMessage((payload) => {
 ...
 function CreatePDF(user, test, details) {
     ...
     var heigth=document.getElementsByTagName("body")[0].offsetHeight-87+1118;
